        ...
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center"><br>
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/mad/map.jpg" alt="Image Placeholder" class="img-fluid"></a>
                 <br>
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">MADHYA-PRADESH ANALYSIS</h3>
        ...
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            ...
            <ul class="list-unstyled footer-link d-flex footer-social">
              <li><a href="#" class="p-2" style="color: olive"><span class="fa fa-twitter"></span></a></li>
              <li><a href="#" class="p-2"style="color: olive"><span class="fa fa-facebook"></span></a></li>
              <li><a href="#" class="p-2"style="color: olive"><span class="fa fa-linkedin"></span></a></li>
              <li><a href="#" class="p-2"style="color: olive"><span class="fa fa-instagram"></span></a></li>
            </ul>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey"style="color: olive">Address:</span>
                  <span style="color: olive">34 Street Name, Madhya Pradesh, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: olive" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: olive">Email:</span><span>info@emp.com</span></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3 mb-5">
            ...
            <ul class="list-unstyled footer-link">
              <li><a href="#"style="color: olive">About</a></li>
              <li><a href="#"style="color: olive">Terms of Use</a></li>
              <li><a href="#"style="color: olive">Disclaimers</a></li>
              <li><a href="#"style="color: olive">Contact</a></li>
            </ul>
          </div>
          <div class="col-md-3">
