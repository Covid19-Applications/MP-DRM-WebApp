...
<!-- <center>
 <a href="http://registration.covid19sikkim.org/" class="btn-buy"><button id="mapsbtn">STRANDED CITIZENS REGISTRATION</button></a>
</center> -->
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='madhya pradesh'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN MADHYA-PRADESH</h1>
  <br><br>
  <!-- <CENTER>
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Madhya Pradesh';
